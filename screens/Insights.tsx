      ...
      >
          <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wide">Current Tariff</div>
                      <div className="text-slate-800 font-bold">₹{DASHBOARD_STATS.currentTariff}/kWh <span className="text-rose-500">({DASHBOARD_STATS.tariffType})</span></div>
                  </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wide">Cheaper Rate In</div>
                      <div className="text-slate-800 font-bold">{DASHBOARD_STATS.cheaperRateIn}</div>
                  </div>
              </div>
          </div>
          <div className="bg-cyan-50 text-cyan-700 px-3 py-2 rounded-xl text-xs font-medium flex items-center gap-2 border border-cyan-100">
              ...
              <span>Smart Tip: Running AC now costs ₹14/hr. Shift to 10 PM.</span>
          </div>
      </motion.div>
